...
function SlotManager:init()
	...
	self._masks.all = World:make_slot_mask(1, 2, 3, 10, 11, 12, 19, 29, 33, 34, 35)
	...
	self._masks.AI_visibility = World:make_slot_mask(1, 11)
	self._masks.AI_visibility_sentry_gun = World:make_slot_mask(1, 11, 17)
