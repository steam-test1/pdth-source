...
function GroupAIStateEmpty:on_enemy_active_state_change(unit, state)
end
...
function GroupAIStateEmpty:flee_point(unit)
end
...
function GroupAIStateEmpty:set_dynamic_spawning_enabled(ratio)
end
...
function GroupAIStateEmpty:report_cop_to_criminal_dis(cop_unit, dis_report)
end
