...
function CoreParticleEditorInitializers:create_centervelocity()
	...
	local help = [[
Determines what position channel to read from:
...
function CoreParticleEditorInitializers:create_boxevenposition()
	...
	initializer:set_description([[
Initializes particle positions evenly distributed within a given box.
...
Positions are always offsetted with effect position.]]
	...
	initializer:add_property(p)
	help = [[
Box inside which particle positions will be generated.
...
function CoreParticleEditorInitializers:create_boxrandomrotation()
	...
	local help = [[
Determines how rotations are treated:
...
function CoreParticleEditorInitializers:create_constantage()
	...
	initializer:set_description([[
Initializes particle ages to specified value.
...
function CoreParticleEditorInitializers:create_localboxrandomposition()
	...
	initializer:set_description([[
Initializes particle positions randomly within a given box.
...
function CoreParticleEditorInitializers:create_lightcone()
	...
	initializer:set_description([[
Constructs a string of positions along a vector, with associated sizes and opacities. Useful for creating light cones.
